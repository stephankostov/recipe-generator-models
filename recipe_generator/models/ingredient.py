...
class IngredientModel(nn.Module):
    ...
    def __init__(self, config, embedding_weights=None):
        ...
        self.transformer = nn.ModuleDict(dict(
            we = FoodEmbeddings(config, embedding_weights),
    ...
    def get_num_params(self, non_embedding=True):
        ...
        if non_embedding:
            n_params -= self.transformer.we.molecule_embeddings.weight.numel()
        return n_params
    ...
    def forward(self, idx):
        ...
        x = self.transformer.drop(self.transformer.we(idx)) # token embeddings of shape (b, t, n_embd)
